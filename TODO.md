...
- [ ] Xác minh hành vi trên bản macOS đang dùng: cửa sổ dồn sang màn hình còn lại, bật lại giữ nguyên sắp xếp *(cần màn hình thứ 2)*
...
- [ ] Tắt màn hình ngoài → cửa sổ dồn về màn hình còn lại → bật lại OK
